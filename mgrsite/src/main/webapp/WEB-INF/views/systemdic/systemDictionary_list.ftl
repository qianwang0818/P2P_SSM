					...
					<table class="table">
						<thead>
							<tr>
								...
								<th class="col-sm-5">编码</th>
								<th>操作</th>
							</tr>
						</thead>
						<tbody>
						<#list pageResult.listData as systemDictionary>
							<tr>
								<td>${systemDictionary.title}</td>
								<td>${systemDictionary.sn}</td>
								<td><a href="javascript:;" class="edit_Btn" data-json='${systemDictionary.getJsonString()!""}'>修改</a></td>
							</tr>
						</#list>
                        </tbody>
					</table>
