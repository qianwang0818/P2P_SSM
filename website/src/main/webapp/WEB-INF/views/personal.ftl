...
<body>
	...
	<!-- 网页导航 -->
	<#assign currentNav="personal"/>	<#--在当前的freemarker的上下文中添加一个K-V变量-->
	...
	<div class="container">
		<div class="row">
			<!--导航菜单-->
			<div class="col-sm-3">
				<#assign currentMenu="personal" /><#--在当前的freemarker的上下文中添加一个K-V变量-->
				...
				<div class="panel panel-default">
					<div class="panel-body el-account">
						...
						<div class="row h4 account-info">
							<div class="col-sm-4">
								账户总额：<span class="text-primary">${account.getTotalAmount()}元</span>
							</div>
							<div class="col-sm-4">
